...
**Frontmatter:** `title`, `pubDate` (required); `summary`, `updatedDate` (optional). Use `updatedDate` when you last meaningfully edited the post so readers can see how up to date it is.
